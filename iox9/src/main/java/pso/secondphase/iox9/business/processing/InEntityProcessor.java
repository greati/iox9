 ...
 */
public abstract class InEntityProcessor<IdentityDataType> extends EntityProcessor<IdentityDataType> {

    public InEntityProcessor(ModelAbstractFactory modelAbstractFactory, 
